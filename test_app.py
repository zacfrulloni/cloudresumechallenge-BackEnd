import boto3
import json
dynamodb = boto3.resource('dynamodb', aws_access_key_id= 'ACCESS_ID', aws_secret_access_key= 'ACCESS_KEY', endpoint_url= "lambda.eu-west-2.amazonaws.com", region_name= 'eu-west-2')
